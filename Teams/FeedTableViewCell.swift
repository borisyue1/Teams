...
class FeedTableViewCell: UITableViewCell {
    ...
    func setupGoingLabel() {
        peopleImage = UIImageView(frame: CGRect(x: dayLabel.frame.minX + 2, y: joinButton.frame.minY - 40, width: 15, height: 15))
        peopleImage.image = #imageLiteral(resourceName: "people")
        rectView.addSubview(peopleImage)
        
        numGoingButton = UIButton(frame: CGRect(x: peopleImage.frame.maxX, y: joinButton.frame.minY - 45, width: 50, height: 22))
